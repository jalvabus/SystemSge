...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="Gustavo/login.php">Iniciar Sesi&oacute;n</a>
                </li>
                <!--<li class="nav-item">
                    <a class="nav-link" href="LoginRegister">Registr&aacute;te</a>
                </li>-->
            </ul>
        </div>
    </nav>
    ...
    <section class="banner">
        <div class="izquierda">
            ...
            <div class="link"><a href="Gustavo/login.php"><span> Iniciar sesión </span></a></div>
        </div>
